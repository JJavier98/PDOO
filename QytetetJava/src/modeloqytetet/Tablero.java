...
//______________________________________________________________________________
    ...
    private void inicializarCasillas()
    {
        ...
        // LADO - 3
            ...
            casillas.add(new Casilla(11, 1100, titulo_7));
            ...
            casillas.add(new Casilla(13, 1200, titulo_8));
            
            // CASILLA 15 - CALLE
            TituloPropiedad titulo_9 = new TituloPropiedad("Ciudad Reloj", 120, (float) 0.16, 700, 750);
            casillas.add(new Casilla(14, 1400, titulo_9));
        ...
        // LADO - 4
            ...
            casillas.add(new Casilla(16, 1500, titulo_10));
            
            // CASILLA 18 - CALLE
            TituloPropiedad titulo_11 = new TituloPropiedad("Altárea", 140, (float) 0.19, 800, 1000);
            casillas.add(new Casilla(17, 1600, titulo_11));
            ...
            casillas.add(new Casilla(19, 2000, titulo_12));
            
        for (Casilla cas : casillas) {
            if(cas.getTipo() == TipoCasilla.CALLE)
                cas.getTitulo().setCasilla(cas);
        }
    }

					...
					if(@jugador.saldo > 0 && !@jugador.encarcelado) # NO ESTÁ EN BANCARROTA NI ESTÁ ENCARCELADO
						...
						if(!@jugador.encarcelado && @jugador.saldo > 0 && @jugador.tengo_propiedades())
							...
							while(opcion != 0 && !@jugador.encarcelado && @jugador.saldo > 0 && @jugador.tengo_propiedades())
                                ...
                                when 1
									if(casilla_elegida.esta_hipotecada())										
										@vista.mostrar("\n--> No puedes construir casa porque la propiedad esta HIPOTECADA"+ "\n")
									elsif(@juego.edificar_casa(casilla_elegida))
                                ...
                                when 2
									if(casilla_elegida.esta_hipotecada())										
										@vista.mostrar("\n--> No puedes construir hotel porque la propiedad esta HIPOTECADA"+ "\n")
									elsif(@juego.edificar_hotel(casilla_elegida))
                                ...
                                when 4
									...
									elsif(@juego.hipotecar_propiedad(casilla_elegida))
                                ...
                                when 5
									...
									elsif(@juego.cancelar_hipoteca(casilla_elegida))
